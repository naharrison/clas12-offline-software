 ...
 *
 */
public final class RECHBParticleBank {
    ...
    public RECHBParticleBank(DataBank dbank, int irow) {
    ...
    static public List<RECHBParticleBank> getRECHBParticleBanks(DataBank dataBank) {
        List<RECHBParticleBank> banks = new ArrayList<>();
        for (int irow = 0; irow < dataBank.rows(); irow++) {
            banks.add(new RECHBParticleBank(dataBank, irow));
        }
        return banks;
    }
}
